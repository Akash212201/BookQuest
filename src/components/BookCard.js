...
const BookCard = ({ book }) => {
  ...
  return (
    <div className="flex md:flex-col lg:flex-col flex-row rounded-lg overflow-hidden bg-white border mb-4 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]">
      ...
      <Link to={`/bookinfo/${book._id}`}>
        ...
        <div className='bg-red-500 py-2 text-xl text-white text-center absolute bottom-0 left-0 right-0' onClick={addToCartHandler}>
