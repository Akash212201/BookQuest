        ...
        <div className='lg:px-8 px-3 py-3 flex justify-between items-center'>
            ...
            <Link to="/dashboard">
                <div className="flex items-center cursor-pointer lg:mr-0 mr-5">
                    <FiUser className="mr-1 text-2xl" /><p className="lg:block hidden">My Account</p>
                </div>
                </Link>
                <Link to="/cart">
                    <div className="flex items-center cursor-pointer">
                        <LuShoppingBag className="lg:mr-2 mr-5 text-2xl" /><p className="lg:block hidden">Cart</p>
                    </div>
                </Link>
