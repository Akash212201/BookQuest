                    ...
                    <div className='px-5 pt-3 font-medium'>
                        ...
                        <div className="my-10 flex items-center lg:text-xl">
                            <button className='flex items-center border px-3 py-2 text-white bg-red-500 cursor-pointer hover:bg-red-600 transition mr-5'>
                                <MdOutlineShoppingCart className="mr-2" />Buy Now</button>
                            <button className='flex items-center border px-3 py-2 text-white bg-red-500 cursor-pointer hover:bg-red-600 transition'>
                                <LuShoppingBag className="mr-2" />Add to Cart</button>
                        </div>
                            ...
                            <div className='mt-1'>
                                {
                                    [4, 3, 2, 1, 0].map((text, idx) => (
                                        ...
                                        <div key={idx} className='flex items-center'>{text + 1}
                                            <IoIosStar />
                                            <span className='border h-3 lg:w-[10vw] w-[30vw] rounded-md mx-2 bg-red-200'>
                                            </span>0
                                        </div>
                                    ))
                                }
