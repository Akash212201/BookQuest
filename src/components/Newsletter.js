  ...
  return (
    <div className="news py-[65px] bg-[#333] flex justify-center items-center flex-col">
        <div className="container mx-auto">
            <h2 className="lg:text-6xl text-2xl text-center text-white">Subscribe to BookQuest Newsletter</h2>
            <div className='border lg:w-[50vw] w-[70vw] mx-auto flex justify-center items-center px-1 my-3'>
