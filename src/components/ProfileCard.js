...
const ProfileCard = () => {
    return (
        <div className='min-w-[250px] duration-300 flex flex-col justify-center items-center top-16 right-6 z-10 bg-white rounded-lg p-[1rem] absolute shadow-[0_3px_10px_rgb(0,0,0,0.2)]'>
            ...
            <h1 className='text-[1.5rem] mt-[0.5rem] font-bold leading-[1.5rem] tracking-wider'>Akash Agrawal</h1>
            <p className='text-[1rem] font-medium tracking-wider'>email.exam@gmail.com</p>
